...
<head>
  ...
  <title>SLLIB | Information Member</title>
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <?php 
    $stud = $_GET['id'];
    $sql = "SELECT * FROM book WHERE book_id='".$stud."'";
     ...
     ?>
          <div class="col-md-6">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title"><h3 class="box-title"><i class="fa fa-user"></i> <?php echo $result['book_title']; ?></h3></h3>
            </div>
            <!-- /.box-header -->
            <br>
            <div class="box-body">
              <dl class="dl-horizontal">
                ...
                <dd><h4><?php echo $result['author']." ".$result['author_2']." ".$result['author_3']."".$result['author_4']." ".$result['author_5']; ?></h4></dd>
                <dt><h4>Publisher Name : </h4></dt>
                <dd><h4><?php echo $result['publisher_name']; ?></h4></dd>
                <dt><h4>Copyright Year : </h4></dt>
                <dd><h4><?php echo $result['copyright_year']; ?></h4></dd>
                <dt><h4>ISBN : </h4></dt>
                <dd><h4><?php echo $result['isbn']; ?></h4></dd>
                <dt><h4>Book Publish : </h4></dt>
                <dd><h4><?php echo $result['book_pub']; ?></h4></dd>
                <dt><h4>Status : </h4></dt>
                <dd><h4><?php echo $result['status']; ?></h4></dd>
          ...
          <div class="col-md-6">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title"><h3 class="box-title">User Added : <i class="fa fa-calendar-o"></i> <?php echo date("M d, Y h:m:s a", strtotime($result['date_added'])); ?></h3></h3>
            </div>
            <!-- /.box-header -->
            <br>
            <div class="box-body">
              <dl class="dl-horizontal">
               <dt><?php if($result['book_image'] != ""): ?>
                <img src="../../img/<?php echo $result['book_image']; ?>" class="img-responsive pad" >
                <?php else: ?>
