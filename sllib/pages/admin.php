      ...
      <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
                ...
                <!----- ----------------------------Start Here--------------------------------->
                    ...
                    <?php endif; ?>
                            ...
                            <div class="form-group">
                              <div class="row">
                                <div class="col-md-6">
                                  <input type="file" value="<?php echo $uprow['admin_image']; ?>" name="image" id="img" class="form-control" required>
                                </div>
                                <div class="col-md-6">
          ...
          {   
            ...
            $_SESSION['status'] = "New Admin Successfully Added";
