...
<head>
  ...
  <title>SLTCFI | LIB Borrowed</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> <span>Home</span></a></li>
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="borrowed.php"><i class="fa fa-book"></i> <span>Borrowed Books</span></a></li>
...
<div class="row">
        <div class="col-md-6">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title"><h3 class="box-title"><i class="fa fa-book"></i> Member Attendace
              </h3></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
         ...
         <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="box-header with-border">
              <a href="attendance/user_login_print.php"><button class="btn btn-danger"><i class="fa fa-print"></i> Print</button></a>
            </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
