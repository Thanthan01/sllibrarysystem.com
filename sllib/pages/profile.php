...
<head>
  ...
  <title>SLTCFI | LIB Profile</title>
  ...
  ?>
        ...
        <div class="col-lg-11">
         ...
         <?php } ?>
              ...
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h4 class="description-block"><?php echo date("M d, Y h:m:s a",strtotime($row['admin_added'])) ?></h4>
                    <span class="description-text">Date Added</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
          ...
          <?php echo $row['firstname']; ?> <?php echo $row['middlename']; ?> <?php echo $row['lastname']; ?></h5>

                    <span class="description-text">Librarian</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
                <div class="col-sm-4">
                  <div class="description-block">
                    ...
                    <span class="description-text"><a href="#modal-default<?php echo $row[0] ?>" class="btn btn-primary" data-toggle="modal"><i class="fa fa-edit"></i> Edit</a></span>
                    <!---------------------------------Update Member---------------------------------->
                <!----- ----------------------------Start Here--------------------------------->
                    <div class="modal fade" id="modal-default<?php  echo $row[0];?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                         ...
                         ?>
                            <form enctype="multipart/form-data" action="admin/profile.php?id=<?php echo $uprow['admin_id']; ?>" method="post">
