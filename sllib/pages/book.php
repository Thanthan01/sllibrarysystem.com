    ...
    <!-- /.sidebar -->
                        ...
                        <?php
                          ...
                          $error = $_FILES["image"] ["error"];
                          {
                                  ...
                                  $_SESSION['status'] = "New Book Successfully Added";
    ...
    <br>
      <div class="box box-primary">
        ...
        <div class="col-md-6">
            ...
            <div class="box-body">
              <dl>
                <a href="book/print.php"><button class="btn btn-danger"><i class="fa fa-print"></i> Print Book Barcode</button></a>
                <a href="book/printlist.php"><button class="btn btn-danger"><i class="fa fa-print"></i> Print Book List</button></a>
              </dl>
            </div>
            <!-- /.box-body -->
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="author_5" id="contact" placeholder="Input Author" class="form-control">
                            </div>
                            <div class="form-group">
                              <label for="address">Publication</label>
                              <input type="name" name="book_pub" id="address" placeholder="Input Publication" class="form-control">
                            </div>
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
              ...
              <a href="book/new_book.php"><button type="button" class="btn btn-primary">New Book</button></a>
              <a href="book/old_book.php"><button type="button" class="btn btn-primary">Old Book</button></a>
              <a href="book/lost_book.php"><button type="button" class="btn btn-primary">Lost Book</button></a>
              <a href="book/damaged_book.php"><button type="button" class="btn btn-primary">Damaged Book</button></a>
              <a href="book/SFR.php"><button type="button" class="btn btn-primary">Subject for Replacement</button></a>
              <a href="book/hard.php"><button type="button" class="btn btn-primary">Hardbound Book</button></a>
            </div>
          </div>
                    ...
                    <div class="modal fade" id="modal-default<?php  echo $row[0];?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                         ...
                         ?>
                            <form enctype="multipart/form-data" action="book/update.php?id=<?php echo $uprow['book_id']; ?>" method="post">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" name="author" value="<?php echo $uprow['author'] ?>" placeholder="Author">
                                      </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="row">
                              <div class="form-group">
                                <div class="col-md-6">
                                  ...
                                  <input type="text" placeholder="Input Author 4" name="author_4" class="form-control" value="<?php echo $uprow['author_4'] ?>">
                                </div>
                                <div class="col-md-6">
                ...
                <div class="modal modal-default fade" id="modal-danger<?php echo $row[0]; ?>">
                  <div class="modal-dialog">
                    ...
                    $del = mysqli_query($con,"select * from book where book_id='".$row['book_id']."'");
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel</button>
                        <a href="book/delete.php<?php echo '?book_id='.$row[0]; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                      </div>
                    </div>
                    <!-- /.modal-content -->
                  </div>
