...
?>
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="about.php"><i class="fa fa-info"></i> <span>About Us</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="container">
        <div class="row">
          <img src="../img/slbanner.png" width="92%">
        </div>
      </div>
      <br>
      <div class="row">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-blue">
              <div class="widget-user-image">
                <img class="img-circle" src="../img/yuri.jpeg" alt="User Avatar">
              </div>
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">Nieves, <br>Yuri</h3>
              <h5 class="widget-user-desc">Developer</h5>
            </div>
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                <li><a href="#">Course: &nbsp BSIS-4</a></li>
                <li><a href="#">Contact Number : 0926077994 </a></li>
                <li><a href="#">Email :<br> Yurinieves12@gmail.com</a></li>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-blue">
              <div class="widget-user-image">
                <img class="img-circle" src="../img/ronard.jpeg" alt="User Avatar">
              </div>
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">Mangampo,<br> Ronard P.</h3>
              <h5 class="widget-user-desc">Developer</h5>
            </div>
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                <li><a href="#">Course: &nbsp BSIS-4</a></li>
                <li><a href="#">Contact Number : 09154895718 </a></li>
                <li><a href="#">Email :<br> mangamporonard@gmail.com</a></li>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-blue">
              <div class="widget-user-image">
                <img class="img-circle" src="../img/giselle.jpg" alt="User Avatar">
              </div>
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">Giselle,<br> Lopera G.</h3>
              <h5 class="widget-user-desc">Developer</h5>
            </div>
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                <li><a href="#">Course: &nbsp BSIS-4</a></li>
                <li><a href="#">Contact Number : 09485914223 </a></li>
                <li><a href="#">Email : <br> loperagiselle17@gmail.com</a></li>
        ...
        <!-- /.col -->
         <div class="col-md-3">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-blue">
              <div class="widget-user-image">
                <img class="img-circle" src="../img/jonathan.jpeg" alt="User Avatar">
              </div>
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">Morco,<br> Jonathan T.</h3>
              <h5 class="widget-user-desc">Developer</h5>
            </div>
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                <li><a href="#">Course: &nbsp BSIS-4</a></li>
                <li><a href="#">Contact Number : 09484144781</a> </li>
                <li><a href="#">Email : <br> morcojonathan14@gmail.com</a></li>
