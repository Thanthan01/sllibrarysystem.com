    ...
    <br>
        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
              ...
              <?php
              $result= mysqli_query($con,"select * from book where status = 'Hard'") or die (mysqli_error());
              while ($row= mysqli_fetch_array ($result) ){
              $id=$row['book_id'];
              ...
              ?>
                ...
                <img src="../../img/<?php echo $row['book_image']; ?>" class="img-thumbnail" width="75px" height="50px">
                <?php else: ?>
